...
const MenuItem = memo(
  ({ item, section, isSelected, isExpanded, onItemClick, onExpandClick }) => {
...
const SubmenuList = memo(
  ({ subsections, selectedSubSection, onSubmenuClick }) => (
    <ul className="header-submenu">
      {subsections.map((subItem) => (
        <li key={subItem.id} className="header-submenu-item">
          <Typography.Link
            className={`header-submenu-item-link ${
              selectedSubSection === subItem.id ? "selected" : ""
            }`}
...
const BottomNavigation = memo(
  ({ selectedSubItems, selectedSubItem, onSubItemChange }) => {
          ...
          <ul className="header-container-bottom-list">
            {selectedSubItems.map((item) => (
              <li className="header-container-bottom-item" key={item.key}>
                <span
                  className={`header-container-bottom-item-link ${
                    selectedSubItem === item.key ? "selected" : ""
                  }`}
  ...
  return (
    <header className="header-pronatura">
      <div className="header-container">
        <HeaderLogo logo={logo} onClick={handleLogoClick} />
        <HeaderTitle title={headerTitle} />
        <Drawer placement="left" onClose={closeDrawer} open={isDrawerOpen}>
          {drawerContent}
        </Drawer>
      </div>
