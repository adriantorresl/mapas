...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>NDR N Tendencia (2100)</se:Name>
    <UserStyle>
      <se:Name>NDR N Tendencia (2100)</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>0 - 300</se:Name>
          <se:Description>
            <se:Title>0 - 300</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>300 - 900</se:Name>
          <se:Description>
            <se:Title>300 - 900</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
        ...
        <se:Rule>
          <se:Name>900 - 1500</se:Name>
          <se:Description>
            <se:Title>900 - 1500</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>1500 - 2100</se:Name>
          <se:Description>
            <se:Title>1500 - 2100</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>2100 - 3202</se:Name>
          <se:Description>
            <se:Title>2100 - 3202</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>3202 - 5245</se:Name>
          <se:Description>
            <se:Title>3202 - 5245</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
