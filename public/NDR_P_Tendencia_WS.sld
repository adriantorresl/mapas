...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>NDR P Tendencia (2100)</se:Name>
    <UserStyle>
      <se:Name>NDR P Tendencia (2100)</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>-74171 - 5000</se:Name>
          <se:Description>
            <se:Title>-74171 - 5000</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>A_2100</ogc:PropertyName>
                <ogc:Literal>-74171.30000000000291038</ogc:Literal>
              </ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>40000 - 80455</se:Name>
          <se:Description>
            <se:Title>40000 - 80455</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>80455 - 106012</se:Name>
          <se:Description>
            <se:Title>80455 - 106012</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>A_2100</ogc:PropertyName>
                <ogc:Literal>106011.5</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
